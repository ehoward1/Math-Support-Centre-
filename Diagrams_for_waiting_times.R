...
#Plot function
Waiting_time_plot = function(dataset, factor_of_interest, title){ 
  ...
  ggplot(data = dataset, aes(x=factor(!!name), y=wait_time)) +
    ...
    theme_bw() + ylab('Wait Time for Students (in min)')+xlab(name)+
...
Waiting_time_plot(dataset = MSC_S1, factor_of_interest = Year, title = "Wait Time Given by Year for Semester 1")
Waiting_time_plot(dataset = MSC_S2, factor_of_interest = Year, title = "Wait Time Given by Year for Semester 2")
Waiting_time_plot(dataset = MSC, factor_of_interest = number_tutors, title = "Wait Time Given by Number of Tutors")
Waiting_time_plot(dataset = MSC, factor_of_interest = term_week, title = "Wait Time Given by Term Week")
Waiting_time_plot(dataset = MSC, factor_of_interest = term_week, title = "Wait Time Given by Hour")
...
Waiting_time_plot(dataset = MSCnorev, factor_of_interest = Day, title = "Wait Time in 2018/19 Sem 1 without revision week")
